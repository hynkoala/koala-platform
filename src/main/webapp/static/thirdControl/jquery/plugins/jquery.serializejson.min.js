...
(function (a) {
    ...
    a.serializeJSON = {
        defaultOptions: {
            ...
            return {
                parseNumbers: b || d.optWithDefaults("parseNumbers", c),
                parseBooleans: b || d.optWithDefaults("parseBooleans", c),
                parseNulls: b || d.optWithDefaults("parseNulls", c),
                useIntKeysAsArrayIndex: d.optWithDefaults("useIntKeysAsArrayIndex", c)
            }
